...
public enum InvitationErrorCode implements ErrorCode {
  ...
  INVITEE_ALREADY_INVITED(
      HttpStatus.CONFLICT, "INV_002", "The invitee has already been invited to this team."),
  PERMISSION_REPLY_INVITATION_DENIED(
      HttpStatus.FORBIDDEN, "INV_003", "You cannot respond to someone else's invitation.");
