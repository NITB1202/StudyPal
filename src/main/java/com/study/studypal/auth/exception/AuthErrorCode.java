...
public enum AuthErrorCode implements ErrorCode {
    ...
    INVALID_ACCESS_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH_005", "Invalid or expired access token."),
    INVALID_REFRESH_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH_005", "Invalid refresh token."),
    ACCOUNT_LOGGED_IN_ANOTHER_DEVICE(HttpStatus.UNAUTHORIZED, "AUTH_006", "Account has been logged in from another device.");
