...
public interface UserRepository extends JpaRepository<User, UUID> {
  @Query(
      """
    SELECT new com.study.studypal.user.dto.response.UserPreviewResponseDto(
    u.id,
    u.name,
    a.email,
    u.avatarUrl
    ...
    ORDER BY u.id ASC
    """)
  List<UserPreviewResponseDto> searchByNameOrEmailWithCursor(
  ...
  @Query(
    ...
    AND u.id <> :userId
    """)
  long countByNameOrEmail(@Param("userId") UUID userId, @Param("keyword") String keyword);
