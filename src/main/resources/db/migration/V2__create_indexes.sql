...
CREATE INDEX idx_files_team_created_at
    ON files (team_id, created_at);

CREATE INDEX idx_folders_team_created_at
    ON folders (team_id, created_at);

CREATE INDEX idx_folders_user_created_at
...
CREATE INDEX idx_tasks_user_start_due
    ON tasks (user_id, start_date, due_date);
